...
def preprocess(file, nobelow):
    ...
    news_df = news_df[['date', 'title', 'summary']]
...
if __name__ == '__main__':
    file = 'DM\\TopicModeling\\한겨레_코로나_요약.csv'
    ...
    for i in range(len(topic_priority)):
        ...
        timeline = topics_to_timeline(news_df, ldamallet, corpus, 3, topic_priority[i], -0.0025 * topic_priority[i] + 0.3) # 마지막 인자 키워드 개수
