...
def topics_to_mongo(news_df, ldamodel, corpus, texts, num_keywords, query, num_topics):
    # Init output
    ...
    for i in range(1,num_topics+1):
        ...
        globals()['df_{}'.format(i)].to_csv ("./result/"+query+"_title_" + str(num_topics) + "/topic("+str(i)+")_news.csv", index = None)
...
if __name__ == '__main__':
    ...
    for tn in topic_priority:
        ...
        topics_to_mongo(news_df, ldamallet, corpus, title_list, 3, query, tn) # 마지막 인자 키워드 개수
